<form id="modalForm" class="">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input name="soal_score" class="form-control" type="number" min="1" max="999" value="<?php echo $data->soal_score;?>">
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea name="soal_content" id="soal_content" class="form-control"><?php echo $data->soal_content;?></textarea>
        </div>
    </div>
    <div class="col-md-12">
...
<script>
    ...
    $('#frsoal_type').val('<?php echo $data->soal_type;?>');
    $('#frsoal_type').select2();
    ...
    $('#modalForm').submit(function () {
        ...
        $.ajax({
            url     : base_url + 'mapel/edit_bank_soal_submit',
            type    : 'POST',
            data    : $(this).serialize(),
            dataType: 'JSON',
            success : function (dtA) {
                if (dtA.t == 0){
                    ...
                    $('.content_'+dtA.id).html(dtA.content);
                    $('.type_'+dtA.id).html(dtA.type);
                    MathJax.Hub.Queue(["Typeset",MathJax.Hub]);
                }
            }
        })
