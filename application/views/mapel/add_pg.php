<form id="modalForm" class="">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input class="form-control" type="number" name="pg_score" min="0" max="<?php echo $data->soal_score;?>" value="0">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="clearfix">
                <label for="ya"><input type="radio" name="pg_is_right" id="ya" value="1"> Ya</label>&nbsp;&nbsp;&nbsp;
                <label for="tidak"><input type="radio" name="pg_is_right" id="tidak" value="0" checked> Tidak</label>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <div class="panel panel-default">
                <div class="panel-body"><?php echo $data->soal_content;?></div>
            </div>
        </div>
    </div>
    <div class="clearfix"></div>
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea name="pg_content" id="pg_content" class="form-control"></textarea>
        </div>
    </div>
    <div class="col-md-12">
...
<script>
    ...
    $('#modalForm').submit(function () {
        ...
        $.ajax({
            url     : base_url + 'mapel/add_pg_submit',
            type    : 'POST',
            data    : $(this).serialize(),
            dataType: 'JSON',
            success : function (dtA) {
                if (dtA.t == 0){
                    ...
                    hide_modal();
                    show_msg(dtA.msg);
                    $('.dataPG_'+dtA.id).append(dtA.html);
