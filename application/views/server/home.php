    ...
    <div class="noprint">
        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a data-toggle="tooltip" class="btn btn-sm btn-primary" href="javascript:;" onclick="print_data();return false" title="Cetak Kartu"><i class="fa fa-print"></i> Cetak Kartu Peserta</a>
                    <a data-toggle="tooltip" class="btn btn-sm btn-primary" href="javascript:;" onclick="show_modal({'href':base_url+'server/add_data/'+$('#tapel').val()+'/'+$('#jn_id').val(),'title':$(this).attr('title')});return false" title="Tambah Server"><i class="fa fa-plus"></i> Tambah Server</a>
                ...
                <form id="formTable">
                    <table id="dataTable" width="100%" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th width="">Nama Server</th>
                            <th width="80px">Jml Client</th>
                            <th width="80px">Jml Ruang</th>
...
<script>
    ...
    function print_data() {
        ...
        if (!tapel || !jn_id){
            ...
            $('#printframe').attr({'src':base_url+'server/cetak_kartu/'+tapel+'/'+jn_id});
            $('.printwrap').show();
            $('.noprint').hide();
        }
    }
